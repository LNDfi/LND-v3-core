...
contract PoolStorage {
  ...
  mapping(address => uint256) internal supplyPoints;
  mapping(address => uint256) internal borrowPoints;
  mapping(address => uint256) internal assetWeightsLending;
  mapping(address => uint256) internal assetWeightsBorrowing;
}
